...
@interface SchoolDetail_ViewController ()<UIActionSheetDelegate>
{
...
@implementation SchoolDetail_ViewController
...
-(void)drawLable
{
    ...
    [bt setImage:[UIImage imageNamed:@"schoolTel.png"] forState:UIControlStateNormal];
...
-(void)requestWithId
{
    ...
    NSString *str =[NSString stringWithFormat:@"http://api.mfeiji.com/v1/schools/%@",self.schoolId];
